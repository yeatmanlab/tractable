...
[![R-CMD-check](https://github.com/richford/tractable/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/richford/tractable/actions/workflows/R-CMD-check.yaml) [![Codecov test coverage](https://codecov.io/gh/richford/tractable/branch/main/graph/badge.svg)](https://app.codecov.io/gh/richford/tractable?branch=main)
...
devtools::install_github("richford/tractable")
```
